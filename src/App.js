...
const trustsignalPages = {
  ...
  sigmo: {
    eyebrow: 'Unified CPaaS',
    title: 'Sigmo Omnichannel Hub',
    intro: 'The ultimate CPaaS workspace. Orchestrate Bulk SMS, WhatsApp, and Voice from one unified visual surface.',
    heroImage: '/assets/features.png',
    heroImageAlt: 'Sigmo CPaaS Orchestration',
    heroBadge: 'Unified Bulk Control',
    heroStatA: { value: 'One', label: 'API Payload' },
    heroStatB: { value: 'All', label: 'Channels' },
    primaryAction: { label: 'Go Omnichannel', to: '/contact' },
    secondaryAction: { label: 'Explore Sigmo', to: '/platform' },
    stats: [
      { value: 'No-Code', label: 'Builders' },
      { value: 'Unified', label: 'Metrics' },
      { value: 'Global', label: 'Routing' },
    ],
    cards: [
      { icon: '🧩', title: 'Bulk Journey Builder', description: 'Design mass-scale customer journeys that span across multiple channels.' },
      { icon: '📡', title: 'Shared Routing Intelligence', description: 'One brain managing routes for SMS, WhatsApp, and Viber globally.' },
      { icon: '🏢', title: 'Team Admin Console', description: 'Enterprise-grade roles, permissions, and sub-account management.' },
      { icon: '📈', title: 'Unified Bulk Analytics', description: 'Consolidated spend and deliverability reports for all communication.' },
      { icon: '⚙️', title: 'Developer Sandboxes', description: 'Test high-volume payloads in a safe, cost-free environment.' },
      { icon: '🔗', title: 'Enterprise Connectors', description: 'Native bulk integrations for Salesforce, HubSpot, and ERP systems.' },
    ],
  },
  blog: {
        ...
        <div className="page">
          ...
          <main>
            <Routes>
              ...
              <Route path="/sigmo" element={<MarketingPageTemplate {...trustsignalPages.sigmo} />} />
              ...
              <Route path="/sign-in" element={<MarketingPageTemplate {...trustsignalPages.signIn} />} />
